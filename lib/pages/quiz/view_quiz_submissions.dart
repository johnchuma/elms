...
class ViewQuizSubmissions extends StatefulWidget {
  const ViewQuizSubmissions({super.key});

  @override
  State<ViewQuizSubmissions> createState() => _ViewSubmissionsState();
}

class _ViewSubmissionsState extends State<ViewQuizSubmissions> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appbar(context, title: "Submissions", actions: [
        GestureDetector(
            onTap: () {
      ...
      body: GetX<QuizSubmissionController>(
                      ...
                      children: find.submissions
                          .map((item) => GestureDetector(
                                onTap: () {
                                  ...
                                  Get.to(() => const QuizSubmissionLecture());
                                },
                                child: Padding(
