...
class AddIndividualAssignment extends StatefulWidget {
  const AddIndividualAssignment({super.key});

  @override
  State<AddIndividualAssignment> createState() =>
      _AddIndividualAssignmentState();
}

class _AddIndividualAssignmentState extends State<AddIndividualAssignment> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appbar(context, title: "Add Individual Assignment"),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              mutedText(text: "Add new individual assignment"),
              const SizedBox(
                height: 10,
              ),
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ShaderMask(
                          ...
                          child: heading("Individual Assignment details",
                              color: Colors.white)),
                      const SizedBox(
                        height: 10,
                      ),
                      TextForm(
                          ...
                          label: "Individual Assignment title"),
                      datePicker(
                          label: "Deadline",
                          hint: "DD/MM/YYYY",
              ...
              customButton("Add individual assignment", loading: loading,
                  onClick: () {
