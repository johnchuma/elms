...
class IndividualAssignmentSubmissionLecture extends StatefulWidget {
  const IndividualAssignmentSubmissionLecture({super.key});

  @override
  State<IndividualAssignmentSubmissionLecture> createState() =>
      _IndividualAssignmentSubmissionLectureState();
}

class _IndividualAssignmentSubmissionLectureState
    extends State<IndividualAssignmentSubmissionLecture> {
  ...
  bool loading = false;
  IndividualAssignmentSubmissionController submissionController = Get.find();
