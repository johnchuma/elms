...
import 'package:elms/pages/individual_assignment/individual_asssignement_submission_lecture.dart';
...
class ViewIndividualAssignmentSubmissions extends StatefulWidget {
  const ViewIndividualAssignmentSubmissions({super.key});

  @override
  State<ViewIndividualAssignmentSubmissions> createState() =>
      _ViewSubmissionsState();
}

class _ViewSubmissionsState extends State<ViewIndividualAssignmentSubmissions> {
  @override
  void initState() {
    Get.put(IndividualAssignmentSubmissionController());
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetX<IndividualAssignmentSubmissionController>(
          init: IndividualAssignmentSubmissionController(),
          builder: (find) {
            return Padding(
                      ...
                      children: find.submissions
                          .map((item) => GestureDetector(
                                onTap: () {
                                  ...
                                  Get.to(() =>
                                      const IndividualAssignmentSubmissionLecture());
                                },
                                child: Padding(
